export class AppError extends Error {
  constructor(
    ...
    public readonly messageKz: string,
...
export const Errors = {
  ...
  aiRateLimit: () =>
    new AppError(
      ...
      "AI сұрауларының лимиті асып кетті. Кейінірек қайталап көріңіз.",
      429
    ),
  aiUnavailable: () =>
    new AppError("AI_PROVIDER_UNAVAILABLE", "AI-сервис временно недоступен.", "AI қызметі уақытша қолжетімсіз.", 503),
  fileTooLarge: () => new AppError("FILE_TOO_LARGE", "Файл слишком большой", "Файл тым үлкен", 413),
  unsupportedFileType: () =>
    new AppError("UNSUPPORTED_FILE_TYPE", "Неподдерживаемый тип файла", "Файл түріне қолдау көрсетілмейді", 415)
};
