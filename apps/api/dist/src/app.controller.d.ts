...
import { AiChatDto, CreateCategoryDto, CreateCourseDto, CreateMaterialDto, CreateQuestionDto, CreateTestDto, EnrollmentDto, GenerateTestDto, LoginDto, PaginationDto, RegisterDto, ReviewDto, SubmitTestDto, UpdateCourseDto, UpdateLanguageDto, UpdateMaterialDto, UpdateProfileDto, UpdateRoleDto, UpdateStatusDto } from "./dto";
...
export declare class AppController {
    ...
    authMe(user: AuthUser): Promise<Omit<{
        id: string;
        email: string;
        passwordHash: string;
        fullName: string;
    ...
    createCategory(user: AuthUser, dto: CreateCategoryDto): Promise<{
        id: string;
        createdAt: Date;
        nameRu: string;
        nameKz: string;
    ...
    updateCategory(user: AuthUser, id: string, dto: CreateCategoryDto): Promise<{
        id: string;
        createdAt: Date;
        nameRu: string;
        nameKz: string;
    ...
    teacherCourses(user: AuthUser, query: PaginationDto & {
        status?: string;
    }): Promise<{
        items: {
            averageRating: number | null;
    ...
    courseStudents(user: AuthUser, courseId: string, query: PaginationDto): Promise<{
        items: {
            progress: {
                id: string;
                updatedAt: Date;
    ...
    aiHistory(token: string, query: PaginationDto): Promise<unknown>;
    summarize(token: string, dto: AiChatDto): Promise<unknown>;
    generateQuestions(token: string, dto: AiChatDto): Promise<unknown>;
    translate(token: string, dto: AiChatDto): Promise<unknown>;
    generateTeacherTest(token: string, dto: GenerateTestDto): Promise<unknown>;
    ...
    notifications(user: AuthUser, query: PaginationDto): Promise<{
        items: {
            id: string;
            createdAt: Date;
    ...
    adminUsers(query: PaginationDto): Promise<{
        items: {
            id: string;
            email: string;
            fullName: string;
    ...
    adminRole(user: AuthUser, id: string, dto: UpdateRoleDto): Promise<Omit<{
        id: string;
        email: string;
        passwordHash: string;
        fullName: string;
    ...
    adminStatus(user: AuthUser, id: string, dto: UpdateStatusDto): Promise<Omit<{
        id: string;
        email: string;
        passwordHash: string;
        fullName: string;
    ...
    adminCourses(query: PaginationDto): Promise<{
        items: {
            teacher: Omit<{
                id: string;
                email: string;
    ...
    auditLogs(query: PaginationDto): Promise<{
        items: ({
            actor: {
                id: string;
                email: string;
    ...
    adminAiHistory(token: string, query: PaginationDto): Promise<unknown>;
